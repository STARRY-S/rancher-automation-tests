...
require (
	...
	github.com/huaweicloud/huaweicloud-sdk-go-v3 v0.1.189
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/tke v1.3.71
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/vpc v1.3.70
